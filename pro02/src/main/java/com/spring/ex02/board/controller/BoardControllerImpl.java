package com.spring.ex02.board.controller;
...
import com.spring.ex02.board.service.BoardService;
...
public class BoardControllerImpl implements BoardController{
	 ...
	 * String viewName = (String) request.getAttribute("viewName"); Map articleMap =
	 * boardService.viewArticle(articleNO); ModelAndView mav = new ModelAndView();
	 * mav.setViewName(viewName); mav.addObject("articleMap", articleMap); return
	 * mav; }
	 */
	...
	public ResponseEntity modArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception{
		...
		ResponseEntity resEnt =null;
		HttpHeaders responseHeaders = new HttpHeaders();
		responseHeaders.add("Content-Type", "text/html; charser=utf-8");
		try {
	 ...
	 * name = (String) enu.nextElement(); String
	 ...
	 * boardService.addNewArticle(articleMap); if(imageFileList!=null &&
	...
	private ModelAndView form(HttpServletRequest request, HttpServletResponse response) throws Exception{
	 ...
	 mFile.getOriginalFilename(); File file = new
	 File(ARTICLE_IMAGE_REPO+"\\"+"temp"+"\\"+fileName); if(mFile.getSize()!=0) {
	 if(!file.exists()) { file.getParentFile().mkdirs(); mFile.transferTo(new
	 File(ARTICLE_IMAGE_REPO+"\\"+"temp"+"\\"+imageFileName)); } } } return
	 imageFileName; }
	 ...
	 * 
	 * fileList.add(originalFileName); File file = new
	 * File(ARTICLE_IMAGE_REPO+"\\"+"temp"+"\\"+fileName); if(mFile.getSize()!=0) {
	 * if(!file.exists()) { file.getParentFile().mkdirs(); mFile.transferTo(new
	 * File(ARTICLE_IMAGE_REPO+"\\"+"temp"+"\\"+originalFileName)); } } } return
	 * fileList; }
	 */
